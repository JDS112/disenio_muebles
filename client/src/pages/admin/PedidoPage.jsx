...
import ModalPedidoEdit from "../../components/ModalPedidoEdit"
  ...
  return (
    <div className="flex flex-row">
      ...
      <div className="">
            ...
            <h1 className=" text-white text-2xl text-center my-2 w-full animate-pulse">Pedidos</h1>
        ...
        <div className="p-4">
            <button className="p-4 text-white bg-green-600 hover:bg-green-500 hover:scale-105 duration-300 rounded-xl mb-2" onClick={()=> context.setIsOpen(true)}>Añadir Pedido</button>
            <ModalPedido/>
            <ModalPedidoEdit/>
            <TablaPedidos/>
        </div>
